...
title: "Homework 0"
subtitle: "BSTA 550"
description: "Due: Thursday October 3, 2024"
date-modified: "today"
categories: [""]
format: 
  html:
...
Please upload a picture of yourself [to Slack](https://join.slack.com/t/bsta550/shared_invite/zt-2qtfo9s8j-j6ozEaYdT7yy1KuHoT9Mhw). Please follow the below steps to add a picture of yourself in Slack:
...
Please complete the [following whenisgood poll](https://whenisgood.net/3giiafw) so that we can schedule office hours. Please use a unique identifier (does not have to be your name), so that I can make sure each student can attend at least one office hour.
...
-   Favorite/recent adventures, restaurants, TV shows, books, podcasts, games, memes, etc.
...
Homework assignments and solutions will be due on a weekly basis. Solutions will be due approximately a week after the assignment was due. There will also be two homework videos/meetings in the quarter. Please look at your calendar, other classes, etc. [Use this form](https://forms.office.com/Pages/ResponsePage.aspx?id=V3lz4rj6fk2U9pvWr59xWFMopmPUjRtDiHLswhgacNhUOFY0UENLSEFLUzkwNkQ1NVIzRVFLWDBENi4u) to rank the days of the week that each of these homeworks parts will be due. Feel free to add any comments. 
